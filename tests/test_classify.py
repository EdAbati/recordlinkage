...
class TestClassifyData:
    ...
    def render_bin_test_data(
        ...
        cls.m = np.array([0.92, 0.81, 0.85, 0.90, 0.99, 0.70, 0.56])
        cls.u = np.array([0.19, 0.23, 0.50, 0.11, 0.20, 0.14, 0.50])
...
class TestClassifyAPI(TestClassifyData):
    ...
    def test_return_result_options(self, classifier):
        ...
        with pytest.raises(ValueError):
            with rl.option_context("classification.return_type", "unknown_return_type"):
    ...
    def test_return_result_options_depr(self, classifier):
        ...
        with pytest.deprecated_call():
            prediction_series = cl.predict(
                comparison_vectors=self.X_train, return_type="series"
            )
            assert isinstance(prediction_series, pd.Series)
        ...
        with pytest.deprecated_call():
            with pytest.raises(ValueError):
                cl.predict(
                    comparison_vectors=self.X_train, return_type="unknown_return_type"
                )
...
class TestECM(TestClassifyData):
    ...
    def test_sklearn_labelbin(self):
        m = np.array([1.0, 0.81, 0.85, 0.81, 0.85, 0.81])
        u = np.array([1.0, 0.23, 0.50, 0.23, 0.30, 0.13])
    ...
    def test_ecm_init(self):
        m = np.array([0.23, 0.81, 0.85, 0.81, 0.85, 0.81])
        u = np.array([0.34, 0.23, 0.50, 0.23, 0.30, 0.13])
    ...
    def test_ecm_init_jaro_1value(self):
        m = np.array([1.0, 0.85, 0.85, 0.81, 0.85, 0.81])
        u = np.array([1.0, 0.10, 0.50, 0.23, 0.30, 0.13])
    ...
    def test_ecm_init_jaro_skewed(self):
        m = np.array([1.0, 0.85, 0.85, 0.81, 0.85, 0.81])
        u = np.array([0.0, 0.10, 0.50, 0.23, 0.30, 0.13])
    ...
    def test_ecm_init_jaro_inf(self):
        m = np.array([0.95, 0.81, 0.85, 0.81, 0.85, 0.81])
        u = np.array([0, 0.23, 0.50, 0.23, 0.30, 0.13])
    ...
    def test_binary_input(self):
        m = np.array([1, 0.81, 0.85, 0.81, 0.85, 0.81])
        u = np.array([1, 0.23, 0.50, 0.23, 0.30, 0.13])
...
class TestFellegiSunter(TestClassifyData):
    @pytest.mark.parametrize("classifier", [rl.NaiveBayesClassifier, rl.ECMClassifier])
